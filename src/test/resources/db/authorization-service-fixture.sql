-- H2 fixture for service tests only; not a production schema.
-- Only the tables needed by Spring context and mapper tests; tests create their own rows.
-- Validate production schema with MySQL + Flyway under base-k8s/scripts/.
